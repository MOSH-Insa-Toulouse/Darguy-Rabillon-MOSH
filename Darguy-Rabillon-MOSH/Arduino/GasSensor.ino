...
void alert()
{
  Serial.println("ALERTEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE");
  delay(100);
...
void initialize_radio()
{
   ...
   */
  const char *devAddr = "26011F53";
const char *nwkSKey = "D8B53A109122FE978A4F2F64EE4FFC37";
const char *appSKey = "C651A7BA19C4CA17133B9078255B6257";
   ...
   */
  //const char *appEui = "70B3D57ED0025C9D";
  //const char *appKey = "78D47B10274C8BE9602940F9D05A44DA";
...
void loop()
{
    ...
    Serial.print("\n\n");
    myLora.tx(String(ratio)); //one byte, blocking function
